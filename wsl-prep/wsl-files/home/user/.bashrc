...
HISTSIZE=2000
HISTFILESIZE=2000
# Enable arrow-key history search based on current input
bind '"\e[A": history-search-backward'
bind '"\e[B": history-search-forward'
# Make Ctrl+R wrap around when reaching end
...
alias dockcdown='docker compose down --remove-orphans'
alias dockcuprc='docker compose up --force-recreate -d'
